...
* component[+].code = $loinc#92822-6 "Genomic coord system"
* component[=].valueCodeableConcept = $loinc#LA30102-0
...
* component[=].valueCodeableConcept = $nuccore#NC_000010.10
* component[+].code = $loinc#53034-5 "Allelic state"
* component[=].valueCodeableConcept = $loinc#LA6705-3 "homozygous"
* component[+].code = $loinc#69547-8 "Ref nucleotide"
* component[=].valueString = "G"
* component[+].code = $loinc#69551-0 "Alt allele"
* component[=].valueString = "A"
...
* component.valueCodeableConcept = $geneId#HGNC:2621 "CYP2C19"
...
* status = #final
* category = $observation-category#laboratory
* code = $loinc#82120-7 "Allelic phase"
* issued = "2019-03-05T16:04:44+00:00"
* valueCodeableConcept = $sequence-phase-relationship-cs#Cis "Cis"
* derivedFrom[0] = Reference(dv-5c7e9e1ca8252)
* derivedFrom[+] = Reference(dv-5c7e9e1ca82e4)
