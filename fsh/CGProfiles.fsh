...
Parent:         Specimen
Id:             fshspecimen
Title:          "Genomics specimen (FSH)"
Description:    "A sample to be used for analysis. (FSH version)"

* subject 1..1
* subject only Reference(Patient or Group or Location)


Profile:        Fshgenomicsbase
Parent:         Observation
Id:             fshgenomicsbase
Title:          "Genomics base (FSH)"
...
Parent:         Observation
Id:             fshtmb
Title:          "Tumor Mutation Burden (FSH)"
Description:    "Definitions for the tmb resource profile. (FSH version). The total number of mutations (changes) found in the DNA of cancer cells. [Source: NCI Dictionary](https://www.cancer.gov/publications/dictionaries/cancer-terms/def/tumor-mutational-burden)"
